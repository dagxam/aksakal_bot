...
FALLBACKS = {
    "playful": {
        1: [
            "{u} — сегодня ты подозрительно серьёзный. Это временно?",
            "{u} — мысль хорошая, не испорть продолжением.",
        ],
        2: [
            "{u} — уверенности много. Теперь осталось найти основания.",
            "{u} — ты так молчишь, будто мнение ещё проходит согласование.",
        ],
        3: [
            "{u} — аргументы закончились, а уверенность почему-то осталась.",
            "{u} — ты сейчас очень смело идёшь туда, где фактов уже нет.",
        ],
        4: [
            "{u} — если бы самоуверенность считалась доказательством, спор уже был бы закрыт.",
            "{u} — мысль закончилась раньше сообщения, но ты героически продолжил.",
        ],
    },
    "supportive": [
        "{u} — не держи всё в себе. Иногда разговор реально помогает.",
    ...
    "stern": [
        "{u} — полегче. Грубость аргумент сильнее не делает.",
    ...
    "wise": [
        ...
        "{u} — половина ошибок начинается там, где вывод делают раньше фактов.",
